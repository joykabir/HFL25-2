...
List<Hero> loadHeroes() {
  ...
  try {
    ...
    final heroes = jsonData.map((json) => Hero.fromJson(json as Map<String, dynamic>)).toList();
...
void showHeroes(List<Hero> heroes) {
  ...
  sortedHeroes.sort((a, b) => b.powerstats.strength.compareTo(a.powerstats.strength));
...
void _printHero(Hero hero) {
  ...
  print('    👤 Gender: ${hero.appearance.gender} | Race: ${hero.appearance.race}');
